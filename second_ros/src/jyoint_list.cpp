...
// the corresponding operation to be specified as an ADD operation
  ...
  attached_object1.link_name = "world";
  /* The header must contain a valid TF frame*/
  attached_object1.object.header.frame_id = "world";
  /* The id of the object */
...
// the corresponding operation to be specified as an ADD operation
  ...
  planning_scene1.world.collision_objects.push_back(attached_object1.object);
